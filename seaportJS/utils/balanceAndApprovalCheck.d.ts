...
export declare const getBalancesAndApprovals: ({
  owner,
  items,
  criterias,
  operator,
...
export declare const getInsufficientBalanceAndApprovalAmounts: ({
 ...
 */
export declare const validateOfferBalancesAndApprovals: ({
  offer,
  criterias,
  balancesAndApprovals,
  timeBasedItemParams,
 ...
 */
export declare const validateBasicFulfillBalancesAndApprovals: ({
  offer,
  consideration,
 ...
 * @returns the list of insufficient owner and proxy approvals
 */
export declare const validateStandardFulfillBalancesAndApprovals: ({
  offer,
  consideration,
  offerCriteria,
