...
exports.getMaximumSizeForOrder =
  exports.getSummedTokenAndIdentifierAmounts =
  exports.getPresentItemAmount =
  exports.isCriteriaItem =
  exports.isErc1155Item =
  exports.isErc721Item =
  exports.isErc20Item =
  exports.isNativeCurrencyItem =
  exports.isCurrencyItem =
    void 0;
...
var isCurrencyItem = function (_a) {
  ...
  return [constants_1.ItemType.NATIVE, constants_1.ItemType.ERC20].includes(
    itemType
  );
};
...
var getPresentItemAmount = function (_a) {
  ...
  var adjustedBlockTimestamp = ethers_1.BigNumber.from(
    isAscending
...
var getSummedTokenAndIdentifierAmounts = function (_a) {
  ...
  var tokenAndIdentifierToSummedAmount = items.reduce(function (map, item) {
    ...
    var identifierOrCriteria =
      (_d =
        (_c = itemToCriteria.get(item)) === null || _c === void 0
          ? void 0
          : _c.identifier) !== null && _d !== void 0
        ? _d
        : item.identifierOrCriteria;
    return __assign(
      __assign({}, map),
      ((_a = {}),
      (_a[item.token] = __assign(
        __assign({}, map[item.token]),
        ((_b = {}),
        (_b[identifierOrCriteria] = (
          (_f =
            (_e = map[item.token]) === null || _e === void 0
              ? void 0
              : _e[identifierOrCriteria]) !== null && _f !== void 0
            ? _f
