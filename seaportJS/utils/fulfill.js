...
exports.getAdvancedOrderNumeratorDenominator =
  exports.generateFulfillOrdersFulfillments =
  exports.fulfillAvailableOrders =
  exports.validateAndSanitizeFromOrderStatus =
  exports.fulfillStandardOrder =
  exports.fulfillBasicOrder =
  exports.shouldUseBasicFulfill =
    void 0;
...
var shouldUseBasicFulfill = function (_a, totalFilled) {
  ...
  var allItems = __spreadArray(
    __spreadArray([], __read(offer), false),
    __read(consideration),
    false
  );
  var nfts = allItems.filter(function (_a) {
    var itemType = _a.itemType;
    return [constants_1.ItemType.ERC721, constants_1.ItemType.ERC1155].includes(
      itemType
    );
  });
  ...
  // 7. First consideration item must contain the offerer as the recipient
  var firstConsiderationRecipientIsNotOfferer =
  ...
  if (
    ...
    restConsideration.every(function (item) {
      return item.itemType === offer[0].itemType;
    }) &&
    (0, order_1.totalItemsAmount)(restConsideration).endAmount.gt(
      offer[0].endAmount
    )
  ) {
    return false;
...
var offerAndConsiderationFulfillmentMapping =
  ((_a = {}),
  (_a[constants_1.ItemType.ERC20] =
    ((_b = {}),
    (_b[constants_1.ItemType.ERC721] =
      constants_1.BasicOrderRouteType.ERC721_TO_ERC20),
    (_b[constants_1.ItemType.ERC1155] =
      constants_1.BasicOrderRouteType.ERC1155_TO_ERC20),
    _b)),
  (_a[constants_1.ItemType.ERC721] =
    ((_c = {}),
    (_c[constants_1.ItemType.NATIVE] =
      constants_1.BasicOrderRouteType.ETH_TO_ERC721),
    (_c[constants_1.ItemType.ERC20] =
      constants_1.BasicOrderRouteType.ERC20_TO_ERC721),
    _c)),
  (_a[constants_1.ItemType.ERC1155] =
    ((_d = {}),
    (_d[constants_1.ItemType.NATIVE] =
      constants_1.BasicOrderRouteType.ETH_TO_ERC1155),
    (_d[constants_1.ItemType.ERC20] =
      constants_1.BasicOrderRouteType.ERC20_TO_ERC1155),
    _d)),
  _a);
    ...
    return __generator(this, function (_h) {
      switch (_h.label) {
        case 0:
          (_f = order.parameters),
            (offer = _f.offer),
            (consideration = _f.consideration);
          considerationIncludingTips = __spreadArray(
            __spreadArray([], __read(consideration), false),
            __read(tips),
            false
          );
          offerItem = offer[0];
          (_g = __read(considerationIncludingTips)),
            (forOfferer = _g[0]),
            (forAdditionalRecipients = _g.slice(1));
          basicOrderRouteType =
            (_b =
              offerAndConsiderationFulfillmentMapping[offerItem.itemType]) ===
              null || _b === void 0
              ? void 0
              : _b[forOfferer.itemType];
          ...
          considerationWithoutOfferItemType = considerationIncludingTips.filter(
            function (item) {
              return item.itemType !== offer[0].itemType;
            }
          );
          totalNativeAmount =
            (_c = (0, item_1.getSummedTokenAndIdentifierAmounts)({
              items: considerationWithoutOfferItemType,
              criterias: [],
              timeBasedItemParams: __assign(__assign({}, timeBasedItemParams), {
                isConsiderationItem: true,
              }),
            })[ethers_1.ethers.constants.AddressZero]) === null || _c === void 0
              ? void 0
              : _c["0"];
          insufficientApprovals = (0,
          balanceAndApprovalCheck_1.validateBasicFulfillBalancesAndApprovals)({
            offer: offer,
          ...
          basicOrderParameters = {
            ...
            basicOrderType:
              order.parameters.orderType + 4 * basicOrderRouteType,
          ...
          return [
            4 /*yield*/,
            (0, approval_1.getApprovalActions)(insufficientApprovals, signer),
          ];
        case 1:
          approvalActions = _h.sent();
          exchangeAction = {
            type: "exchange",
            transactionMethods: (0, usecase_1.getTransactionMethods)(
          ...
          actions = __spreadArray(
            __spreadArray([], __read(approvalActions), false),
            [exchangeAction],
            false
          );
          return [
    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        case 0:
          ...
          (_e = orderWithAdjustedFills.parameters),
            (offer = _e.offer),
            (consideration = _e.consideration);
          considerationIncludingTips = __spreadArray(
            __spreadArray([], __read(consideration), false),
            __read(tips),
            false
          ...
          considerationCriteriaItems = considerationIncludingTips.filter(
            function (_a) {
              var itemType = _a.itemType;
              return (0, item_1.isCriteriaItem)(itemType);
            }
          ...
          hasCriteriaItems =
            offerCriteriaItems.length > 0 ||
            considerationCriteriaItems.length > 0;
          if (
          ...
          totalNativeAmount =
            (_b = (0, item_1.getSummedTokenAndIdentifierAmounts)({
              items: considerationIncludingTips,
              criterias: considerationCriteria,
              timeBasedItemParams: __assign(__assign({}, timeBasedItemParams), {
                isConsiderationItem: true,
              }),
            })[ethers_1.ethers.constants.AddressZero]) === null || _b === void 0
              ? void 0
              : _b["0"];
          insufficientApprovals = (0,
          balanceAndApprovalCheck_1.validateStandardFulfillBalancesAndApprovals)(
            {
              offer: offer,
              consideration: considerationIncludingTips,
        ...
        case 1:
          ...
          orderAccountingForTips = __assign(__assign({}, order), {
            parameters: __assign(__assign({}, order.parameters), {
              consideration: __spreadArray(
                __spreadArray(
                  [],
                  __read(order.parameters.consideration),
                  false
                ),
                __read(tips),
                false
          ...
          (_f = (0, exports.getAdvancedOrderNumeratorDenominator)(
            order,
            unitsToFill
          )),
          ...
          exchangeAction = {
            ...
            transactionMethods: useAdvanced
              ? (0, usecase_1.getTransactionMethods)(
                  seaportContract.connect(signer),
                  "fulfillAdvancedOrder",
                  [
                    __assign(__assign({}, orderAccountingForTips), {
                      numerator: numerator,
                      denominator: denominator,
                      extraData:
                        extraData !== null && extraData !== void 0
                          ? extraData
                          : "0x",
                    }),
                    hasCriteriaItems
...
function fulfillAvailableOrders(_a) {
  var ordersMetadata = _a.ordersMetadata,
    ...
    recipientAddress = _a.recipientAddress;
  return __awaiter(this, void 0, void 0, function () {
    var sanitizedOrdersMetadata,
      ordersMetadataWithAdjustedFills,
      totalNativeAmount,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          sanitizedOrdersMetadata = ordersMetadata.map(function (
            orderMetadata
          ) {
            ...
            function (orderMetadata) {
              return __assign(__assign({}, orderMetadata), {
                ...
                order: orderMetadata.unitsToFill
                  ...
                  : // Else, we adjust the order by the remaining order left to be fulfilled
                    (0, order_1.mapOrderAmountsFromFilledStatus)(
                      orderMetadata.order,
                      {
                        totalFilled: orderMetadata.orderStatus.totalFilled,
                        totalSize: orderMetadata.orderStatus.totalSize,
          ...
          addApprovalIfNeeded = function (orderInsufficientApprovals) {
            orderInsufficientApprovals.forEach(function (insufficientApproval) {
              if (
                !totalInsufficientApprovals.find(function (approval) {
          ...
          ordersMetadataWithAdjustedFills.forEach(function (_a) {
            ...
            var order = _a.order,
              ...
              offererBalancesAndApprovals = _a.offererBalancesAndApprovals,
              offererOperator = _a.offererOperator;
            var considerationIncludingTips = __spreadArray(
              __spreadArray([], __read(order.parameters.consideration), false),
              __read(tips),
              false
            );
            ...
            totalNativeAmount = totalNativeAmount.add(
              (_c =
                (_b = (0, item_1.getSummedTokenAndIdentifierAmounts)({
                  ...
                  criterias: considerationCriteria,
                  timeBasedItemParams: timeBasedItemParams,
                })[ethers_1.ethers.constants.AddressZero]) === null ||
                _b === void 0
                  ? void 0
                  : _b["0"]) !== null && _c !== void 0
                ? _c
            ...
            var offerCriteriaItems = order.parameters.offer.filter(function (
              _a
            ) {
              var itemType = _a.itemType;
              return (0, item_1.isCriteriaItem)(itemType);
            });
            var considerationCriteriaItems = considerationIncludingTips.filter(
              function (_a) {
                var itemType = _a.itemType;
                return (0, item_1.isCriteriaItem)(itemType);
              }
          ...
          return [
            4 /*yield*/,
            (0, approval_1.getApprovalActions)(
              totalInsufficientApprovals,
              signer
            ),
          ];
        case 1:
          ...
          advancedOrdersWithTips = sanitizedOrdersMetadata.map(function (_a) {
            var order = _a.order,
              ...
              tips = _a.tips,
              extraData = _a.extraData;
            var _c = (0, exports.getAdvancedOrderNumeratorDenominator)(
                order,
                unitsToFill
              ),
          ...
          (_b = generateFulfillOrdersFulfillments(ordersMetadata)),
            (offerFulfillments = _b.offerFulfillments),
            (considerationFulfillments = _b.considerationFulfillments);
          exchangeAction = {
            type: "exchange",
            transactionMethods: (0, usecase_1.getTransactionMethods)(
              seaportContract.connect(signer),
...
function generateFulfillOrdersFulfillments(ordersMetadata) {
  ...
  ordersMetadata.forEach(function (_a, orderIndex) {
    var order = _a.order,
      offererOperator = _a.offererOperator,
      offerCriteria = _a.offerCriteria;
    var itemToCriteria = (0, criteria_1.getItemToCriteriaMap)(
    ...
    return order.parameters.offer.forEach(function (item, itemIndex) {
      ...
      var aggregateKey = ""
        .concat(
          hashAggregateKey({
            ...
            identifier:
              (_b =
                (_a = itemToCriteria.get(item)) === null || _a === void 0
                  ? void 0
                  : _a.identifier) !== null && _b !== void 0
                ? _b
      ...
      offerAggregatedFulfillments[aggregateKey] = __spreadArray(
        __spreadArray(
          [],
          __read(
            (_c = offerAggregatedFulfillments[aggregateKey]) !== null &&
              _c !== void 0
              ? _c
              : []
          ),
  ...
  ordersMetadata.forEach(function (_a, orderIndex) {
    ...
    return __spreadArray(
      ...
      var aggregateKey = ""
        ...
        .concat((0, item_1.isErc721Item)(item.itemType) ? itemIndex : "");
      considerationAggregatedFulfillments[aggregateKey] = __spreadArray(
        __spreadArray(
          [],
          __read(
            (_c = considerationAggregatedFulfillments[aggregateKey]) !== null &&
              _c !== void 0
              ? _c
              : []
          ),
