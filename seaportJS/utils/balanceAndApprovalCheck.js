...
exports.validateStandardFulfillBalancesAndApprovals =
  exports.validateBasicFulfillBalancesAndApprovals =
  exports.validateOfferBalancesAndApprovals =
  exports.getInsufficientBalanceAndApprovalAmounts =
  exports.getBalancesAndApprovals =
    void 0;
...
var findBalanceAndApproval = function (
          ...
          items.map(function (item) {
            return __awaiter(void 0, void 0, void 0, function () {
              ...
              return __generator(this, function (_d) {
                switch (_d.label) {
                  case 0:
                    approvedAmountPromise = Promise.resolve(
                      ethers_1.BigNumber.from(0)
                    );
                    if (
                      (0, item_1.isErc721Item)(item.itemType) ||
                      (0, item_1.isErc1155Item)(item.itemType)
                    ) {
                      approvedAmountPromise = (0,
                      approval_1.approvedItemAmount)(
                        owner,
                        item,
                        operator,
                        multicallProvider
                    ...
                    _a = {
                      ...
                      identifierOrCriteria:
                        (_c =
                          (_b = itemToCriteria.get(item)) === null ||
                          _b === void 0
                            ? void 0
                            : _b.identifier) !== null && _c !== void 0
                          ? _c
                          : item.identifierOrCriteria,
                    };
                    return [
                      4 /*yield*/,
                      (0, balance_1.balanceOf)(
                        owner,
                        item,
                        multicallProvider,
...
var getInsufficientBalanceAndApprovalAmounts = function (_a) {
  var balancesAndApprovals = _a.balancesAndApprovals,
    ...
    operator = _a.operator;
  var tokenAndIdentifierAndAmountNeeded = __spreadArray(
    [],
    __read(
      Object.entries(tokenAndIdentifierAmounts).map(function (_a) {
        var _b = __read(_a, 2),
          token = _b[0],
    ...
    return tokenAndIdentifierAndAmountNeeded
      ...
      .map(function (_a) {
        var _b = __read(_a, 3),
          ...
          identifierOrCriteria = _b[1],
          amount = _b[2];
        var balanceAndApproval = findBalanceAndApproval(
          balancesAndApprovals,
          token,
          identifierOrCriteria
        );
  ...
  var mapToApproval = function (insufficientBalance) {
    return {
      ...
      tokenAndIdentifierAmounts: (0, item_1.getSummedTokenAndIdentifierAmounts)(
        {
          ...
          timeBasedItemParams: timeBasedItemParams
            ? __assign(__assign({}, timeBasedItemParams), {
...
var validateStandardFulfillBalancesAndApprovals = function (_a) {
  ...
  var fulfillerBalancesAndApprovalsAfterReceivingOfferedItems =
...
var addToExistingBalances = function (_a) {
  ...
  var balancesAndApprovalsAfterReceivingItems = balancesAndApprovals.map(
    function (item) {
