...
exports.shouldUseMatchForFulfill =
  exports.generateRandomSalt =
  exports.mapOrderAmountsFromUnitsToFill =
  exports.mapOrderAmountsFromFilledStatus =
  exports.totalItemsAmount =
  exports.areAllCurrenciesSame =
  exports.mapInputItemToOfferItem =
  exports.deductFees =
  exports.feeToConsiderationItem =
    void 0;
...
var feeToConsiderationItem = function (_a) {
  ...
  return {
    itemType:
      token === ethers_1.ethers.constants.AddressZero
...
var mapInputItemToOfferItem = function (item) {
  ...
  if ("itemType" in item) {
    ...
    if ("identifiers" in item) {
      ...
      return {
        itemType:
          item.itemType === constants_1.ItemType.ERC721
        ...
        endAmount:
          (_c =
            (_b = item.endAmount) !== null && _b !== void 0
              ? _b
              : item.amount) !== null && _c !== void 0
            ? _c
            : "1",
      };
    }
    if ("amount" in item || "endAmount" in item) {
      return {
        ...
        endAmount:
          (_e =
            (_d = item.endAmount) !== null && _d !== void 0
              ? _d
              : item.amount) !== null && _e !== void 0
            ? _e
            : "1",
      };
    }
  ...
  return {
    itemType:
      item.token && item.token !== ethers_1.ethers.constants.AddressZero
        ? constants_1.ItemType.ERC20
        : constants_1.ItemType.NATIVE,
    token:
      (_f = item.token) !== null && _f !== void 0
        ? _f
        : ethers_1.ethers.constants.AddressZero,
    identifierOrCriteria: "0",
    startAmount: item.amount,
    endAmount:
      (_g = item.endAmount) !== null && _g !== void 0 ? _g : item.amount,
  };
};
...
var mapOrderAmountsFromUnitsToFill = function (order, _a) {
  ...
  var basisPoints = remainingOrderPercentageToBeFilled.gt(
...
var generateRandomSalt = function () {
  return "0x".concat(
    Buffer.from(ethers_1.ethers.utils.randomBytes(16)).toString("hex")
  );
};
exports.generateRandomSalt = generateRandomSalt;
var shouldUseMatchForFulfill = function () {
  return true;
};
