 ...
 */
export declare const shouldUseBasicFulfill: (
  { offer, consideration, offerer }: OrderParameters,
  totalFilled: OrderStatus["totalFilled"]
) => boolean;
export declare function fulfillBasicOrder({
  order,
  seaportContract,
  ...
  >
>;
export declare function fulfillStandardOrder({
  order,
  unitsToFill,
  totalSize,
  totalFilled,
  ...
  >
>;
export declare function validateAndSanitizeFromOrderStatus(
  order: Order,
...
export declare function fulfillAvailableOrders({
  ordersMetadata,
  seaportContract,
  fulfillerBalancesAndApprovals,
  fulfillerOperator,
  ...
  >
>;
export declare function generateFulfillOrdersFulfillments(
  ordersMetadata: FulfillOrdersMetadata
): {
...
export declare const getAdvancedOrderNumeratorDenominator: (
  order: Order,
  unitsToFill?: BigNumberish | undefined
) => {
  numerator: BigNumber;
