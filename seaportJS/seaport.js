...
var Seaport = /** @class */ (function () {
  ...
  function Seaport(provider, _a) {
    ...
    this.getOrderHash = function (orderComponents) {
      var offerItemTypeString =
        "OfferItem(uint8 itemType,address token,uint256 identifierOrCriteria,uint256 startAmount,uint256 endAmount)";
      var considerationItemTypeString =
        "ConsiderationItem(uint8 itemType,address token,uint256 identifierOrCriteria,uint256 startAmount,uint256 endAmount,address recipient)";
      var orderComponentsPartialTypeString =
        "OrderComponents(address offerer,address zone,OfferItem[] offer,ConsiderationItem[] consideration,uint8 orderType,uint256 startTime,uint256 endTime,bytes32 zoneHash,uint256 salt,bytes32 conduitKey,uint256 counter)";
      var orderTypeString = ""
        .concat(orderComponentsPartialTypeString)
        .concat(considerationItemTypeString)
        .concat(offerItemTypeString);
      var offerItemTypeHash = ethers_1.ethers.utils.keccak256(
        ethers_1.ethers.utils.toUtf8Bytes(offerItemTypeString)
      );
      var considerationItemTypeHash = ethers_1.ethers.utils.keccak256(
        ethers_1.ethers.utils.toUtf8Bytes(considerationItemTypeString)
      );
      var orderTypeHash = ethers_1.ethers.utils.keccak256(
        ethers_1.ethers.utils.toUtf8Bytes(orderTypeString)
      );
      var offerHash = ethers_1.ethers.utils.keccak256(
        "0x" +
                ...
                .keccak256(
                  "0x" +
                    [
                      ...
                      ethers_1.ethers.BigNumber.from(
      ...
      var considerationHash = ethers_1.ethers.utils.keccak256(
        "0x" +
      ...
      var derivedOrderHash = ethers_1.ethers.utils.keccak256(
        "0x" +
          [
    ...
    this.multicallProvider = new multicall_1.providers.MulticallProvider(
      provider
    );
    this.contract = new ethers_1.Contract(
      (_f =
        overrides === null || overrides === void 0
          ? void 0
          : overrides.contractAddress) !== null && _f !== void 0
        ? _f
        : constants_1.CROSS_CHAIN_SEAPORT_ADDRESS,
      Seaport_1.SeaportABI,
    ...
    this.config = {
      ...
      balanceAndApprovalChecksOnOrderCreation:
        balanceAndApprovalChecksOnOrderCreation,
      conduitKeyToConduit: __assign(
        __assign(
          __assign({}, constants_1.KNOWN_CONDUIT_KEYS_TO_CONDUIT),
          ((_b = {}), (_b[constants_1.NO_CONDUIT] = this.contract.address), _b)
        ),
        conduitKeyToConduit
      ),
    };
    this.defaultConduitKey =
      (_g =
        overrides === null || overrides === void 0
          ? void 0
          : overrides.defaultConduitKey) !== null && _g !== void 0
        ? _g
        : constants_1.NO_CONDUIT;
  }
  /**
  ...
  Seaport.prototype._getOrderTypeFromOrderOptions = function (_a) {
    ...
    return restrictedByZone
      ? constants_1.OrderType.FULL_RESTRICTED
      : constants_1.OrderType.FULL_OPEN;
  };
  /**
      ...
      return __generator(this, function (_k) {
        switch (_k.label) {
          ...
          case 2:
            ...
            considerationItems = __spreadArray(
              [],
              __read(
                consideration.map(function (consideration) {
                  var _a;
                  return __assign(
                    __assign(
                      {},
                    ...
                    {
                      recipient:
                        (_a = consideration.recipient) !== null && _a !== void 0
                          ? _a
                          : offerer,
                    }
                  );
            ...
            currencies = __spreadArray(
              __spreadArray([], __read(offerItems), false),
              __read(considerationItems),
              false
            ).filter(item_1.isCurrencyItem);
            totalCurrencyAmount = (0, order_1.totalItemsAmount)(currencies);
            operator = this.config.conduitKeyToConduit[conduitKey];
            return [
              4 /*yield*/,
              Promise.all([
                counter !== null && counter !== void 0
                  ? counter
                  : this.getCounter(offerer),
          ...
          case 3:
            (_h = __read.apply(void 0, [_k.sent(), 2])),
              (resolvedCounter = _h[0]),
              (balancesAndApprovals = _h[1]);
            orderType = this._getOrderTypeFromOrderOptions({
              allowPartialFills: allowPartialFills,
              restrictedByZone: restrictedByZone,
            });
            considerationItemsWithFees = __spreadArray(
              __spreadArray(
                [],
                __read((0, order_1.deductFees)(considerationItems, fees)),
                false
              ),
              __read(
                currencies.length
                  ? (_b =
                      fees === null || fees === void 0
                        ? void 0
            ...
            orderParameters = {
              ...
              zone: zone,
              // TODO: Placeholder
              zoneHash: (0, utils_1.formatBytes32String)(
                resolvedCounter.toString()
              ),
              startTime: startTime,
              endTime: endTime,
              orderType: orderType,
              ...
              totalOriginalConsiderationItems:
                considerationItemsWithFees.length,
              salt: salt,
            ...
            insufficientApprovals = checkBalancesAndApprovals
              ? (0,
                balanceAndApprovalCheck_1.validateOfferBalancesAndApprovals)({
                  offer: offerItems,
                  criterias: [],
          ...
          case 6:
            ...
            createOrderAction = {
              ...
              getMessageToSign: function () {
                return _this._getMessageToSign(
                  orderParameters,
                  resolvedCounter
                );
              },
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              JSON.stringify(
                utils_1._TypedDataEncoder.getPayload(
                  domainData,
                  constants_1.EIP_712_ORDER_TYPE,
                  orderComponents
                )
              ),
            ];
   ...
   */
  Seaport.prototype.signOrder = function (
    orderParameters,
    counter,
    accountAddress
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              ethers_1.ethers.utils.splitSignature(signature).compact,
            ];
        }
      });
    });
  ...
  Seaport.prototype.cancelOrders = function (orders, accountAddress) {
    ...
    return (0, usecase_1.getTransactionMethods)(
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
            ...
            return [
              ...
              Promise.all([
                ...
                (0, balanceAndApprovalCheck_1.getBalancesAndApprovals)({
                  ...
                  criterias: __spreadArray(
                    __spreadArray([], __read(offerCriteria), false),
                    __read(considerationCriteria),
                    false
                  ),
                  multicallProvider: this.multicallProvider,
          ...
          case 3:
            (_h = __read.apply(void 0, [_j.sent(), 4])),
              (offererBalancesAndApprovals = _h[0]),
              (fulfillerBalancesAndApprovals = _h[1]),
              (currentBlock = _h[2]),
              (orderStatus = _h[3]);
            currentBlockTimestamp = currentBlock.timestamp;
            (totalFilled = orderStatus.totalFilled),
              (totalSize = orderStatus.totalSize);
            sanitizedOrder = (0, fulfill_1.validateAndSanitizeFromOrderStatus)(
              order,
              orderStatus
            );
            timeBasedItemParams = {
            ...
            tipConsiderationItems = tips.map(function (tip) {
              return __assign(
                __assign({}, (0, order_1.mapInputItemToOfferItem)(tip)),
                { recipient: tip.recipient }
              );
            });
            isRecipientSelf =
              recipientAddress === ethers_1.ethers.constants.AddressZero;
            ...
            if (
              !unitsToFill &&
              isRecipientSelf &&
              (0, fulfill_1.shouldUseBasicFulfill)(
            ...
            return [
              2 /*return*/,
              (0, fulfill_1.fulfillStandardOrder)({
                order: sanitizedOrder,
  ...
  Seaport.prototype._fulfillOrder = function (_a) {
    var order = _a.order,
      unitsToFill = _a.unitsToFill,
      _b = _a.offerCriteria,
      offerCriteria = _b === void 0 ? [] : _b,
  ...
  Seaport.prototype.fulfillOrders = function (_a) {
    var fulfillOrderDetails = _a.fulfillOrderDetails,
      ...
      recipientAddress =
        _c === void 0 ? ethers_1.ethers.constants.AddressZero : _c;
    return __awaiter(this, void 0, void 0, function () {
      var fulfiller,
        fulfillerAddress,
        allOffererOperators,
        ...
        switch (_e.label) {
          ...
          case 2:
            ...
            allOffererOperators = fulfillOrderDetails.map(function (_a) {
              var order = _a.order;
              return _this
                .config.conduitKeyToConduit[order.parameters.conduitKey];
            });
            fulfillerOperator = this.config.conduitKeyToConduit[conduitKey];
            ...
            allConsiderationCriteria = fulfillOrderDetails.flatMap(function (
              _a
            ) {
            ...
            return [
              ...
              Promise.all([
                Promise.all(
                  fulfillOrderDetails.map(function (_a, i) {
                    var order = _a.order,
                      _b = _a.offerCriteria,
                      offerCriteria = _b === void 0 ? [] : _b;
                    return (0,
                    balanceAndApprovalCheck_1.getBalancesAndApprovals)({
                ...
                (0, balanceAndApprovalCheck_1.getBalancesAndApprovals)({
                  owner: fulfillerAddress,
                  items: __spreadArray(
                    __spreadArray([], __read(allOfferItems), false),
                    __read(allConsiderationItems),
                    false
                  ),
                  criterias: __spreadArray(
                    __spreadArray([], __read(allOfferCriteria), false),
                    __read(allConsiderationCriteria),
                    false
                  ),
                  operator: fulfillerOperator,
                  multicallProvider: this.multicallProvider,
                ...
                this.multicallProvider.getBlock("latest"),
                Promise.all(
                  fulfillOrderDetails.map(function (_a) {
                    var order = _a.order;
                    return _this.getOrderStatus(
                      _this.getOrderHash(order.parameters)
                    );
                  })
                ),
              ]),
          ...
          case 3:
            (_d = __read.apply(void 0, [_e.sent(), 4])),
              (offerersBalancesAndApprovals = _d[0]),
              (fulfillerBalancesAndApprovals = _d[1]),
              (currentBlock = _d[2]),
              (orderStatuses = _d[3]);
            ordersMetadata = fulfillOrderDetails.map(function (
              orderDetails,
              index
            ) {
              var _a, _b, _c, _d, _e;
              return {
                ...
                offerCriteria:
                  (_a = orderDetails.offerCriteria) !== null && _a !== void 0
                    ? _a
                    : [],
                considerationCriteria:
                  (_b = orderDetails.considerationCriteria) !== null &&
                  _b !== void 0
                    ? _b
                    : [],
                tips:
                  (_d =
                    (_c = orderDetails.tips) === null || _c === void 0
                      ? void 0
                      : _c.map(function (tip) {
                          return __assign(
                            __assign(
                    ...
                    : [],
                extraData:
                  (_e = orderDetails.extraData) !== null && _e !== void 0
                    ? _e
                    : "0x",
                offererBalancesAndApprovals:
                  offerersBalancesAndApprovals[index],
                offererOperator: allOffererOperators[index],
              };
            });
            return [
              2 /*return*/,
              (0, fulfill_1.fulfillAvailableOrders)({
